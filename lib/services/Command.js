...
var LEDS;
(function (LEDS) {
    LEDS[LEDS["BOTTOM"] = 0] = "BOTTOM";
    LEDS[LEDS["RIGHT"] = 1] = "RIGHT";
    LEDS[LEDS["MIDDLE"] = 2] = "MIDDLE";
    LEDS[LEDS["LEFT"] = 3] = "LEFT";
    LEDS[LEDS["NOSE"] = 4] = "NOSE";
})(LEDS = exports.LEDS || (exports.LEDS = {}));
...
class CommandService {
    ...
    async blinkLED(led, color) {
        ...
        const rgba = colorToRGBA(color);
        const choreography = String.fromCharCode.apply(null, [
            0, MTL_OPCODE_HANDLERS.frame_duration, 50,
            0, MTL_OPCODE_HANDLERS.set_led_color, led, rgba[0], rgba[1], rgba[2], 0, 0,
            3, MTL_OPCODE_HANDLERS.set_led_color, led, 0, 0, 0, 0, 0,
            3, MTL_OPCODE_HANDLERS.set_led_color, led, rgba[0], rgba[1], rgba[2], 0, 0,
            3, MTL_OPCODE_HANDLERS.set_led_color, led, 0, 0, 0, 0, 0,
            3, MTL_OPCODE_HANDLERS.set_led_color, led, rgba[0], rgba[1], rgba[2], 0, 0,
            3, MTL_OPCODE_HANDLERS.set_led_color, led, 0, 0, 0, 0, 0
        ]);
